...
def multi_layers_relu_xavier(ph_x):
    ...
    w3 = tf.get_variable('w3', shape=[256, 10], initializer=tf.glorot_uniform_initializer)
...
def multi_layers_relu_xavier_5(ph_x):
    ...
    w4 = tf.get_variable('w4', shape=[128, 64], initializer=tf.glorot_uniform_initializer)
    b4 = tf.Variable(tf.zeros([64]))

    w5 = tf.get_variable('w5', shape=[64, 10], initializer=tf.glorot_uniform_initializer)
...
# acc : 0.9149 (baseline)
# acc : 0.8816 (multi_layers_simple)
# acc : 0.1028 (multi_layers_sigmoid)
# acc : 0.9526 (multi_layers_relu)
# acc : 0.9783 (multi_layers_relu_xavier)
# acc : 0.9735 (multi_layers_relu_xavier_5)
